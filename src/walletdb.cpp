             ...
             bool& fIsEncrypted,  bool& fAnyUnordered, string& strType, string& strErr)
{
    try {
		...
		else if (strType == "stakeSplitThreshold") //presstab PayCon
		{
            ssValue >> pwallet->nStakeSplitThreshold;
		}
		else if (strType == "multisend") //presstab PayCon
		{
			unsigned int i;
			ssKey >> i;
		...
		else if(strType == "msettings")//presstab PayCon
		{
		...
		else if(strType == "mdisabled")//presstab PayCon
		{
