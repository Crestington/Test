            ...
            while (true)
            {
                ...
                if (nChange > 0)
                {
                    ...
                    else
                    {
						...
						// change PayCon to get rid of automatic generation of change address and instead send change back
...
{
    //presstab PayCon: return false if disablestake RPC is enabled
	if(fDisableStake)
		return false;
